...
class PressurePlate(gym.Env):
    ...
    def __init__(self, height=10, width=10, n_agents=4, sensor_range=1, layout= 'linear'):
    ...
    def _get_obs(self):
        ...
        for agent in self.agents:
            ...
            # Concat
            obs.append(np.concatenate((_agents, _plates, _goal, np.array([x, y])), axis=0, dtype=np.float32))
    ...
    def _init_render(self):
        from MARL_course.assignment_3.backup.rendering import Viewer
