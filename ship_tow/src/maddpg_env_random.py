...
def collect_rewards(num_episodes=100, max_steps=1000):
...
def plot_reward_curve(num_episodes=100, smoothing_window=10):
...
# Run the reward curve visualization
plot_reward_curve(num_episodes=500)